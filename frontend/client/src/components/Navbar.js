	...
	<div className="container flex justify-between h-16 mx-auto">
		<div className="flex">
			...
			<ul className="items-stretch hidden space-x-3 lg:flex">
				...
				<li className="flex">
					<a rel="noopener noreferrer" href="#" className="flex items-center px-4 -mb-1 border-b-2 border-transparent text-violet-400 border-violet-400">Dashboard</a>
				</li>
			</ul>
		</div>
		<div className="items-center space-x-8 flex-shrink-0 hidden lg:flex">
			<button className="px-8 py-3 font-semibold rounded bg-violet-400 text-gray-900">Log in</button>s
